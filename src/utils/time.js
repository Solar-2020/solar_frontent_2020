...
export function getNowTime() {
    ...
    let str = `${data.getFullYear()}-${month}-${day + 1}T${data.toTimeString(data.getTime).split(' ')[0]}.${data.getMilliseconds()}${data.toTimeString(data.getTime).split('GMT')[1].substr(0, 3)}:00`;
    console.log('-----------');
    console.log(str);
